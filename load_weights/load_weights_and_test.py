...
def test():
    ...
    otolitt.load_weights('../weights/output_checkpoints_inceptionV3_img_400_not_cropped_avgpool_seed8/kfold_-1_400_400_mean_prediction_seed8.006.hdf5')

    pred_a = otolitt.predict(x_otolith_rescaled_normalized)
    pred_b = otolitt.predict(x_otolith_rescaled*1./255)
    print(pred_a)
    print(pred_b)
