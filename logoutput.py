...
#what_is_new = "ResNet152, 50 epochs, linear training"
what_is_new = "Take 2 validate size 8% Correct split, 300 epochs, on 3batches(new formated images) Imagenet,  inceptionV3 linear 512x512 RGB training, GlobalMaxPooling, RMSprop, mean of otolith pairs to new MSE"
today_date = "15mai"
type_output = "linear"
network = "inceptionV3_"
image_format= "_RGB_"
adir = "./log_validate16_maxpooling_no_zca/"
